...
//        String ret = result2.substring(0, 8);
    ...
    public static String getUUID() {
        ...
        String s1 = s.substring(0, 8) + s.substring(9, 13) + s.substring(14, 18)
                + s.substring(19, 23) + s.substring(24);//去掉“-”符号

        //ZJGenUuid()
        String data1 = s.substring(0, 8);
        String data2 = s.substring(9, 13);
        String data3 = s.substring(14, 18);
        char data4[] = (s.substring(19, 23) + s.substring(24)).toCharArray();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Mac_919(key, null, "abcdefabcdefabcdeffabcdefabcdefabcdeff"));
